...
public class DebugDraw {
    ...
    //6floats per vertex, 2 vertices per line
    private static float[] vertexArray = new float[MAX_LINES * 6];
    ...
    public static void addBox2D(Vector2f center, Vector2f dimensions, float rotation) {
        //TODO add constants for common colors
        addBox2D(center, dimensions, rotation, new Vector3f(1, 0, 1), 1);
    }
    ...
    public static void addCircle2D(Vector2f center, float radius) {
        //TODO add constants for common colors
        addCircle2D(center, radius, new Vector3f(1, 0, 1), 1);
    }
